...
import { AnalysisScreen, ReadyScreen, UnsupportedScreen } from './components/AnalysisScreens';
...
export default function SmartCullingReviewPage({
  ...
  if (screen === 'unsupported') content = <UnsupportedScreen snapshot={snapshot} onExit={onBackToLibrary} />;
    ...
    content = <AnalysisScreen snapshot={snapshot} images={imageList} onBrowseLibrary={onBackToLibrary} />;
  else if (screen === 'ready')
    content = <ReadyScreen snapshot={snapshot} images={imageList} onBrowseLibrary={onBackToLibrary} />;
